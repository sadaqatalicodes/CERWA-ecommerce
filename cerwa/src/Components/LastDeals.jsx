...
import product2 from "../assets/lap2.jpg";
import product3 from "../assets/lap3.jpg";
import product4 from "../assets/lap4.jpg";
import product5 from "../assets/mob1.jpg";
import product6 from "../assets/mob2.jpg";
import product7 from "../assets/mob3.jpg";
import product8 from "../assets/mob4.jpg";
import product9 from "../assets/w1.jpg";
import product10 from "../assets/w9.jpg";
import product11 from "../assets/w3.jpg";
import product12 from "../assets/w6.jpg";
          ...
          <div className="mx-auto mb-6">
            <div className="flex justify-center">
              {[1, 2, 3].map((tabNumber) => (
                <button
                  key={tabNumber}
                  className={`tab-btn inline-block font-semibold sm:px-2 px-0 sm:mx-6 mx-2 text-sm sm:text-base relative rounded-t-lg uppercase ${
                    activeTab === tabNumber ? "active" : ""
                  }`}
                  onClick={() => handleTabClick(tabNumber)}
                >
                  <span
                    className={`tab-label hover:text-red-600 ${
                      activeTab === tabNumber ? "active" : ""
                    }`}
                  >
                    {tabNumber === 1 && "Laptop"}
                    {tabNumber === 2 && "Mobile phones"}
                    {tabNumber === 3 && "Smart watches"}
                  </span>
                  {activeTab === tabNumber && (
                    <span className="underline absolute bottom-0 left-0 w-full h-[3px] bg-red-600"></span>
                  )}
                </button>
              ))}
            </div>
            {/* <hr className="border-[1px] border-gray-400 sm:mx-6 mx-2 " /> */}
