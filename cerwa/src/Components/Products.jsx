  ...
  return (
    ...
    <div class=" bg-gray-100 flex flex-col justify-center">
      <h1 className="text-center mt-10 text-4xl font-semibold text-gray-800">
        Feature <span className="text-red-600 font-bold">Products</span>
      </h1>
      ...
      <div class="relative m-3 flex flex-wrap mx-auto justify-center">
        <div class="relative max-w-sm min-w-[290px] bg-white shadow-md rounded-3xl p-2 mx-4 my-3 cursor-pointer">
          <div class="overflow-x-hidden rounded-2xl relative">
            <img class="h-48 rounded-2xl w-full object-contain" src={product1} />
        ...
        <div class="relative max-w-sm min-w-[290px] bg-white shadow-md rounded-3xl p-2 mx-4 my-3 cursor-pointer">
          <div class="overflow-x-hidden rounded-2xl relative">
            <img class="h-48 rounded-2xl w-full object-contain" src={product2} />
            <p class="absolute right-2 top-2 bg-white rounded-full p-2 cursor-pointer group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 group-hover:opacity-50 opacity-70"
        ...
        <div class="relative max-w-sm min-w-[290px] bg-white shadow-md rounded-3xl p-2 mx-4 my-3 cursor-pointer">
          <div class="overflow-x-hidden rounded-2xl relative">
            <img class="h-48 rounded-2xl w-full object-contain" src={product3} />
            <p class="absolute right-2 top-2 bg-white rounded-full p-2 cursor-pointer group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 group-hover:opacity-50 opacity-70"
        ...
        <div class="relative max-w-sm min-w-[290px] bg-white shadow-md rounded-3xl p-2 mx-4 my-3 cursor-pointer">
          <div class="overflow-x-hidden rounded-2xl relative">
            <img class="h-48 rounded-2xl w-full object-contain" src={product4} />
            <p class="absolute right-2 top-2 bg-white rounded-full p-2 cursor-pointer group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 group-hover:opacity-50 opacity-70"
        ...
        <div class="relative max-w-sm min-w-[290px] bg-white shadow-md rounded-3xl p-2 mx-4 my-3 cursor-pointer">
          <div class="overflow-x-hidden rounded-2xl relative">
            <img class="h-48 rounded-2xl w-full object-contain" src={product5} />
            <p class="absolute right-2 top-2 bg-white rounded-full p-2 cursor-pointer group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 group-hover:opacity-50 opacity-70"
        ...
        <div class="relative max-w-sm min-w-[290px] bg-white shadow-md rounded-3xl p-2 mx-4 my-3 cursor-pointer">
          <div class="overflow-x-hidden rounded-2xl relative">
            <img class="h-48 rounded-2xl w-full object-contain" src={product6} />
            <p class="absolute right-2 top-2 bg-white rounded-full p-2 cursor-pointer group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 group-hover:opacity-50 opacity-70"
        ...
        <div class="relative max-w-sm min-w-[290px] bg-white shadow-md rounded-3xl p-2 mx-4 my-3 cursor-pointer">
          <div class="overflow-x-hidden rounded-2xl relative">
            <img class="h-48 rounded-2xl w-full object-contain" src={product7} />
            <p class="absolute right-2 top-2 bg-white rounded-full p-2 cursor-pointer group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 group-hover:opacity-50 opacity-70"
        ...
        <div class="relative max-w-sm min-w-[290px] bg-white shadow-md rounded-3xl p-2 mx-4 my-3 cursor-pointer">
          <div class="overflow-x-hidden rounded-2xl relative">
            <img class="h-48 rounded-2xl w-full object-contain" src={product8} />
            <p class="absolute right-2 top-2 bg-white rounded-full p-2 cursor-pointer group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 group-hover:opacity-50 opacity-70"
